<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/home ">
            <img src="../assets/img/PeduliDiri.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">PeduliDiri</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('home')) ? 'active' : '' }}" href="/home">
                    ...
                    <span class="nav-link-text ms-1">Perjalanan Table</span>
                </a>
            </li>
            {{-- @if(users->role='admin') --}}
            <li class="nav-item">
            ...
            {{-- @endif --}}
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Add Perjalanan</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('form')) ? 'active' : '' }}" href="/form">
                    ...
                    <span class="nav-link-text ms-1">Tambah Perjalanan</span>
                </a>
            </li>
