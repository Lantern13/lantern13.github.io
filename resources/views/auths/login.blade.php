      ...
      <div class="page-header min-vh-100">
        <div class="container">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">Login User</h4>
                </div>
                <div class="card-body">
                  <form role="form" method="POST" action="/postLogin">
                    {{ csrf_field() }}
                    <div class="mb-3">
                      <input id="nama" name="nama" type="text" class="form-control form-control-lg" placeholder="Nama" aria-label="Nama">
                      @if ($errors->has('nama'))
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <span class="alert-text"><strong>Warning!</strong> {{ $errors->first('nama') }}</span>
                    ...
                    <div class="mb-3">
                      <input id="nik" name="nik" type="text" class="form-control form-control-lg" placeholder="NIK" aria-label="NIK">
                      @if ($errors->has('nik'))
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <span class="alert-text"><strong>Warning!</strong> {{ $errors->first('nik') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <span class="alert-text"><strong>Warning!</strong> {{ $errors->first('password') }}</span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Maybe nothing in this world happens by accident. As everything happens for a reason, our destiny slowly takes form."</h4>
                <p class="text-white position-relative"> – Silvers Rayleigh.</p>
              </div>
            </div>
          </div>
        </div>
