      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Buatlah akun dengan memasukkan Nama dan NIK.</p>
            <p class="text-lead text-white">NIK tidak boleh sama dengan user lain.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" method="POST" action="/simpanRegister">
                {{ csrf_field() }}
                <div class="mb-3">
                  <input id="nama" name="nama" type="text" class="form-control" placeholder="Nama" aria-label="Name">
                  @if ($errors->has('nama'))
                ...
                <div class="mb-3">
                  <input id="nik" name="nik" type="text" class="form-control" placeholder="NIK" aria-label="NIK">
                  @if ($errors->has('nik'))
                  <div class="alert alert-warning alert-dismissible fade show" role="alert">
              ...
              <p class="text-sm mt-3 mb-0">Already have an account? <a href="/" class="text-dark font-weight-bolder">Login</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            Copyright © <script>
              document.write(new DateTime())
            </script>2022 Soft by Puji Nugraha.
          </p>
        </div>
      </div>
    </div>
